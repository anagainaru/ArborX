...
int main(int argc, char *argv[]) {
  ...
  for (int i = 0; i < nrepeats; i++) {
    ...
    // printf("Bounding Volume Hierarchy\n");
    {
      ...
      bvh.query(
          space, predicates, ArborX::Details::CallbackDefaultSpatialPredicate{},
          indices, offset,
    ...
    // printf("Brute Force\n");
    {
      ...
      brute.query(space, predicates,
                  ArborX::Details::CallbackDefaultSpatialPredicate{}, indices,
                  offset);
